  ...
  return (
    <div style={s.levelCard}>
      <div style={s.levelTop}>
        ...
        <div style={s.xpBox}>
          <div style={{ fontSize: 11, color: "rgba(255,255,255,0.6)" }}>Total XP</div>
      ...
      <div style={{ marginTop: 14 }}>
        <div style={s.levelBarLabel}>
          ...
          <span style={{ fontSize: 11, color: "rgba(255,255,255,0.6)" }}>{level.pct}%</span>
        </div>
...
const s = {
  ...
  levelNum:     { fontSize:12, color:"rgba(255,255,255,0.6)", marginTop:2 },
  xpBox:        { textAlign:"right" },
  levelBarLabel:{ display:"flex", justifyContent:"space-between", marginBottom:6 },
  levelBarBg:   { height:8, background:"rgba(255,255,255,0.1)", borderRadius:10, overflow:"hidden" },
