        ...
        <div style={{ background: "var(--surface)", border: `1px solid ${C.border}`, borderRadius: 24, padding: "24px 22px", backdropFilter: "blur(20px)", boxShadow: "0 24px 60px rgba(0,0,0,0.4)" }}>
          ...
          <label style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 18, cursor: "pointer" }}>
            <input type="checkbox" checked={agreedToTerms}
              ...
              style={{ marginTop: 3, width: 16, height: 16, flexShrink: 0, accentColor: C.purple }} />
            <span style={{ fontSize: 12.5, color: C.muted, lineHeight: 1.6 }}>
              I agree to the{" "}
              <Link to="/terms" target="_blank" style={{ color: C.purple, fontWeight: 700, textDecoration: "none" }}>
                Terms of Service
              </Link>
              {" "}and{" "}
              <Link to="/privacy" target="_blank" style={{ color: C.purple, fontWeight: 700, textDecoration: "none" }}>
                Privacy Policy
              </Link>
              . If you're under 18, please have a parent or guardian aware of this before continuing.
            </span>
          </label>
