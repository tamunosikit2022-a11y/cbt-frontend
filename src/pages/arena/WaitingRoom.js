...
function PlayerRow({ p, isSelf, isHost, canKick, onKick }) {
  return (
    <div style={{
      ...
      background: isSelf ? "#6c63ff18" : "var(--bg)",
...
function Loader({ text, isError, onBack }) {
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "sans-serif", gap: 16 }}>
...
const s = {
  ...
  codeBox:         { background: "var(--surface)", border: "2px solid #6c63ff", borderRadius: 12, padding: "8px 14px", textAlign: "center", cursor: "pointer", display: "flex", flexDirection: "column", gap: 2, minWidth: 130 },
  ...
  squadBox:        { background: "var(--bg)", borderRadius: 10, padding: 10, border: "2px solid", display: "flex", flexDirection: "column", gap: 7 },
  emptySlot:       { display: "flex", alignItems: "center", gap: 8, background: "var(--bg)", borderRadius: 10, padding: "9px 12px", border: "1px dashed #2d2d44", opacity: 0.5 },
  ...
  reactBtn:        { fontSize: 22, background: "var(--bg)", border: "1px solid #2d2d44", borderRadius: 8, padding: "6px 10px", cursor: "pointer" },
  ...
  chatInput:       { flex: 1, background: "var(--bg)", border: "1px solid #2d2d44", borderRadius: 8, padding: "8px 10px", color: "#fff", fontSize: 13 },
  ...
  modal:           { background: "var(--surface)", border: "1px solid #6c63ff", borderRadius: 16, padding: "28px 32px", textAlign: "center", maxWidth: 340, width: "90%" },
