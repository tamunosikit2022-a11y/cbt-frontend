...
const VIDEOS = [
  // ── ELITRONIX OFFICIAL ──
  {
    ...
    subject:"General",    topic:"JAMB Strategy",
    title:"How I Scored 333 in JAMB — Study Strategy That Works",
    duration:"", views:"", videoId:"XsYqCLlNfms",
    new: true,
  },
  ...
  { id:"b3", channel:"classnotes", subject:"Biology", topic:"Genetics",
    ...
    duration:"18:45", views:"180K", videoId:"", searchQuery:"genetic diagrams inheritance JAMB biology",
  ...
  { id:"c1", channel:"flashlearners", subject:"Chemistry", topic:"Mole Concept",
    ...
    duration:"12:05", views:"890K", videoId:"", searchQuery:"mole concept chemistry JAMB tutorial",
  ...
  { id:"c3", channel:"classnotes", subject:"Chemistry", topic:"Mole Calculations",
    ...
    duration:"28:14", views:"340K", videoId:"", searchQuery:"mole calculations chemistry step by step",
  ...
  { id:"p3", channel:"classnotes", subject:"Physics", topic:"Electricity",
    ...
    duration:"31:20", views:"3.2M", videoId:"", searchQuery:"DC electric circuits explained physics",
    credit:"The Organic Chemistry Tutor" },
  ...
  { id:"m2", channel:"examready", subject:"Mathematics", topic:"Statistics",
    ...
    duration:"18:06", views:"2.8M", videoId:"", searchQuery:"mean median mode range tutorial",
    credit:"The Organic Chemistry Tutor" },
  ...
  { id:"e1", channel:"flashlearners", subject:"English", topic:"Grammar",
    ...
    duration:"12:08", views:"4.1M", videoId:"", searchQuery:"parts of speech English grammar full lesson",
    credit:"English Tutor" },

  // Economics
  { id:"ec1", channel:"classnotes", subject:"Economics", topic:"Supply & Demand",
    title:"Supply and Demand — Khan Academy",
    duration:"10:34", views:"3.3M", videoId:"", searchQuery:"supply and demand economics Khan Academy",
    credit:"Khan Academy" },

  // Government
  { id:"g1", channel:"examready", subject:"Government", topic:"Democracy",
    title:"Types of Government Explained — Democracy & More",
    duration:"8:23", views:"1.5M", videoId:"", searchQuery:"types of government explained democracy",
    credit:"CrashCourse" },
];
        ...
        <div style={s.eliGrid}>
          {VIDEOS.filter(v => v.channel === "elitronix").map(v => (
            <div key={v.id} style={{ ...s.eliCard, ...(v.comingSoon ? s.eliCardSoon : {}) }}
              onClick={() => !v.comingSoon && (v.videoId ? setPlaying(v) : window.open(v.youtubeUrl || "https://www.youtube.com/@elitronix1/videos", "_blank"))}>
...
const s = {
  page:          { maxWidth:480, margin:"0 auto", minHeight:"100vh", background:"var(--bg)", fontFamily:"'Plus Jakarta Sans',sans-serif", display:"flex", flexDirection:"column" },
  ...
  officialAvatar:{ width:52, height:52, background:"var(--border)", borderRadius:14, display:"flex", alignItems:"center", justifyContent:"center", fontSize:28, flexShrink:0, border:"2px solid rgba(255,255,255,0.3)" },
  ...
  notifRow:      { background:"var(--surface)", borderRadius:12, padding:"10px 12px", display:"flex", alignItems:"center", gap:10, marginBottom:10 },
  ...
  viewAllBtn:    { padding:"11px 14px", background:"var(--border)", color:"#fff", border:"1px solid rgba(255,255,255,0.3)", borderRadius:10, fontWeight:700, fontSize:12, cursor:"pointer", whiteSpace:"nowrap" },
  ...
  eliSoonText:   { fontSize:10, color:"var(--text-muted)", padding:"0 10px 10px", lineHeight:1.3 },
  ...
  subjectActive: { background:"var(--primary)", color:"#fff", borderColor:"var(--primary)" },

  // Player
  playerCard:    { background:"var(--surface)", borderRadius:16, overflow:"hidden", marginBottom:16, marginTop:8 },
  playerHeader:  { padding:"12px 14px", display:"flex", gap:10, alignItems:"flex-start" },
  playerTitle:   { fontWeight:800, fontSize:13, color:"#fff" },
  playerMeta:    { fontSize:11, color:"var(--text-muted)", marginTop:2 },
  closeBtn:      { background:"var(--surface)", border:"none", color:"#fff", borderRadius:8, width:30, height:30, cursor:"pointer", fontSize:14, flexShrink:0 },
  ...
  videoCardActive:{ borderColor:"var(--primary)", background:"rgba(124,92,255,.1)" },
