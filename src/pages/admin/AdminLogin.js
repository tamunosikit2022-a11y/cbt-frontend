...
export default function AdminLogin() {
  ...
  const expired = new URLSearchParams(window.location.search).get("reason") === "expired";
  const [error, setError] = useState(expired ? "⏱️ Your session expired. Please log in again." : "");
...
const s = {
  page:  { minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"var(--bg)", fontFamily:"sans-serif" },
  card:  { background:"var(--surface)", borderRadius:16, padding:"36px 32px", width:"100%", maxWidth:400, border:"1px solid #2d2d44" },
  ...
  input: { width:"100%", padding:"11px 14px", background:"var(--bg)", border:"1px solid #2d2d44", borderRadius:8, fontSize:14, color:"#fff", boxSizing:"border-box" },
