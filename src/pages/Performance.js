...
function StatCard({ icon, label, value, color }) {
  return (
    <div style={{ background: "#111827", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12, padding: "14px 16px", flex: 1, minWidth: 100, textAlign: "center" }}>
...
const s = {
  ...
  weakCard:    { background: "#111827", borderRadius: 10, padding: 14, textAlign: "center", borderTop: "3px solid #e17055" },
  ...
  subjectCard: { background: "#111827", borderRadius: 10, padding: "12px 14px" },
  table:       { background: "#111827", borderRadius: 12, overflow: "hidden", border: "1px solid rgba(255,255,255,0.07)" },
  ...
  emptyState:  { background: "#111827", borderRadius: 14, padding: "40px 20px", textAlign: "center", border: "1px solid rgba(255,255,255,0.07)" },
