    ...
    <div style={s.page}>
      <div style={s.card}>
              ...
              <span key={n} style={{ display: "flex", alignItems: "center" }}>
                <span style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
                  <span style={{
                    ...
                    color:       done || active ? "var(--surface)" : "#b2bec3",
        ...
        <p style={{ textAlign: "center", marginTop: 8 }}>
          <Link to="/login" style={{ ...s.link, fontSize: 12, color: "var(--text-muted)" }}>← Back to Login</Link>
        </p>
      </div>
    </div>
  );
...
const s = {
  ...
  card:       { background: "var(--surface)", borderRadius: 16, padding: "28px 28px 24px", width: "100%", maxWidth: 420, boxShadow: "0 8px 40px rgba(0,0,0,0.2)" },
  title:      { textAlign: "center", fontSize: 22, fontWeight: 800, marginBottom: 2, color: "var(--text)" },
  sub:        { textAlign: "center", color: "var(--text-muted)", marginBottom: 20, fontSize: 13 },
  ...
  infoBox:    { display: "flex", gap: 10, alignItems: "flex-start", background: "color-mix(in srgb, var(--primary) 10%, var(--surface))", border: "1px solid color-mix(in srgb, var(--primary) 30%, transparent)", borderRadius: 10, padding: "12px 14px", marginBottom: 14, fontSize: 13, color: "var(--text)", lineHeight: 1.5 },
  errorBox:   { background: "rgba(239,68,68,0.1)", border: "1px solid rgba(239,68,68,0.3)", borderRadius: 8, padding: "10px 14px", color: "#e17055", fontWeight: 600, marginBottom: 12, fontSize: 13 },
  successBox: { background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: 8, padding: "10px 14px", color: "#00b894", fontWeight: 700, marginBottom: 12, textAlign: "center", fontSize: 13 },
  label:      { display: "block", fontSize: 13, fontWeight: 600, color: "var(--text)", marginBottom: 6, marginTop: 14 },
  ...
  btn:        { width: "100%", padding: 13, background: "linear-gradient(135deg,#6c63ff,#3f51b5)", color: "var(--surface)", border: "none", borderRadius: 10, fontWeight: 800, fontSize: 15, cursor: "pointer", marginTop: 14 },
  ghostBtn:   { width: "100%", padding: 10, background: "transparent", color: "var(--text-muted)", border: "1px solid var(--border)", borderRadius: 10, fontWeight: 600, fontSize: 13, cursor: "pointer", marginTop: 8 },
  linkBtn:    { background: "none", border: "none", color: "#6c63ff", fontWeight: 700, cursor: "pointer", fontSize: 13, textDecoration: "underline" },
  help:       { fontSize: 12, color: "var(--text-muted)", textAlign: "center", marginTop: 14, lineHeight: 1.6 },
  foot:       { textAlign: "center", marginTop: 16, fontSize: 13, color: "var(--text-muted)" },
