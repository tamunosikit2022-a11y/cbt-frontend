  ...
  if (loading) return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"var(--bg)" }}>
      <div style={{ textAlign:"center" }}>
        ...
        <p style={{ color:"var(--primary)", marginTop:16, fontFamily:"'Plus Jakarta Sans',sans-serif" }}>Loading Factions…</p>
      </div>
    </div>
  );
          ...
          <div style={{ background:"linear-gradient(135deg,rgba(124,92,255,.15),rgba(0,212,255,.08))",
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:12 }}>
              ...
              <div style={{ display:"flex", gap:16 }}>
                ...
                <div style={{ textAlign:"center" }}>
                  <p style={{ color:"var(--primary)", fontWeight:900, fontSize:22, margin:0 }}>{(mySchool.total_xp||0).toLocaleString()}</p>
                ...
                <div key={s.school_name} className={`school-row ${i===0?"top1":i===1?"top2":i===2?"top3":""} ${isMe?"mine":""}`}>
                  ...
                  <div style={{ flex:1, minWidth:0 }}>
                    <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                      ...
                      {isMe && <span style={{ fontSize:10, background:"rgba(124,92,255,.3)", color:"var(--primary)",
            ...
            {states.map((s, i) => (
              <div key={s.state} className={`school-row ${i===0?"top1":i===1?"top2":i===2?"top3":""}`}>
                ...
                <div style={{ textAlign:"right" }}>
                  <p style={{ color:"var(--primary)", fontWeight:800, fontSize:15, margin:0 }}>
                    {(s.total_xp||0).toLocaleString()}
                  </p>
                  <p style={{ color:"rgba(255,255,255,.4)", fontSize:11, margin:0 }}>Total XP</p>
                </div>
