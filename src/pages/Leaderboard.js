  ...
  return (
    <div style={s.page}>
      <div style={s.container}>
        ...
        {/* TABLE */}
        {loading ? (
          <p style={{ textAlign: "center", color: "#636e72", padding: 40 }}>Loading...</p>
        ) : board.length === 0 ? (
          <div style={s.empty}>
...
const s = {
  ...
  filters:      { background: "#fff", borderRadius: 12, padding: 16, marginBottom: 16, boxShadow: "0 2px 10px rgba(0,0,0,0.05)", display: "flex", gap: 16, flexWrap: "wrap" },
  filterGroup:  { flex: 1, minWidth: 200 },
  filterLabel:  { display: "block", fontWeight: 700, fontSize: 12, color: "#636e72", marginBottom: 6 },
  tabs:         { display: "flex", gap: 6 },
  tab:          { padding: "7px 12px", border: "2px solid #dfe6e9", borderRadius: 8, fontWeight: 600, cursor: "pointer", fontSize: 12, background: "#fff" },
  select:       { width: "100%", padding: "8px 10px", border: "2px solid #dfe6e9", borderRadius: 8, fontSize: 14, background: "#fff" },
