    ...
    <div style={s.page}>
      <div style={s.container}>
        ...
        <div style={s.panel}>
          ...
          {scores.map((p, i) => (
            <div key={p.playerId}
              style={{ ...s.row, background: p.playerId === playerId ? "#6c63ff22" : "var(--bg)", border: p.playerId === playerId ? "1px solid #6c63ff" : "1px solid #2d2d44", opacity: p.eliminated ? 0.5 : 1 }}>
...
function StatBox({ label, value, color }) {
  return (
    <div style={{ flex: 1, background: "var(--surface)", borderRadius: 12, padding: "14px 10px", textAlign: "center", border: "1px solid #2d2d44" }}>
...
const s = {
  ...
  panel:        { background: "var(--surface)", borderRadius: 14, padding: "16px", border: "1px solid #2d2d44", marginBottom: 14 },
