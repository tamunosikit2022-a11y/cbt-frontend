...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    text: "This is your Dashboard. See your XP, streak, coins, and tokens at a glance. Tap the bottom tabs to navigate the whole app. The 🔔 bell shows notifications and the ≡ menu opens more features.",
    highlight: null,
  ...
  },
  {
    ...
    text: "Complete missions every day to earn bonus XP, coins, and tokens. Missions include things like: complete 3 exams, answer 50 questions, win an arena battle. Check the Missions page daily and claim your rewards!",
    highlight: null,
  ...
  },
  {
    ...
    text: "Spin the wheel once a day for free rewards — coins, tokens, XP, or boost multipliers. Premium scholars get 2 spins per day! A 2× boost doubles your XP or coins earned for 24 hours.",
    highlight: null,
    action: { label: 'Spin Now', path: '/rewards' },
  },
  {
    id: 'performance',
  ...
  },
  {
    ...
    text: "Upgrade to Premium for extra perks: 100 AI messages per day, 2 daily spins, exclusive items in the Token Store, and more. Go to the Upgrade page to see the plans.",
    highlight: null,
        ...
        <div style={{
          ...
          {speechSupported() && (
            <button onClick={toggleVoice} title={voiceOn ? 'Mute voice' : 'Enable voice'} style={{
              background: voiceOn ? 'rgba(255,255,255,0.25)' : "var(--surface)",
        ...
        <div style={{ padding: '16px 16px 12px' }}>
          ...
          {speaking && voiceOn && (
            <div style={{ display: 'flex', gap: 4, alignItems: 'center', marginBottom: 8 }}>
              ...
              <span style={{ fontSize: 11, color: "var(--text-muted)", marginLeft: 4 }}>Speaking...</span>
            </div>
          )}
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button onClick={prev} disabled={step === 0} style={{
              ...
              borderRadius: 10, color: step === 0 ? "var(--border)" : '#fff',
