        ...
        <div style={{ ...s.scoreCard, borderTop:`6px solid ${grade.color}` }}>
          ...
          {isJAMBFull && jambScore ? (
            <>
              ...
              <div style={{ fontSize:18, color:"var(--text-muted)", marginBottom:4 }}>out of {jambScore.maxScore}</div>
              <div style={{ fontSize:20, fontWeight:700, color:"#f0f4ff" }}>{grade.label}</div>
            ...
            <>
              ...
              <div style={{ fontSize:20, fontWeight:700, color:"#f0f4ff", marginTop:4 }}>{grade.label}</div>
...
const s = {
  ...
  expl:         { background:"#e8f8f5", borderRadius:8, padding:"10px 12px", fontSize:13, color:"#f0f4ff", lineHeight:1.6 },
};
