...
const s = {
  ...
  subjectBadge:{ background: "#1a1a2e", border: "1px solid #6c63ff", borderRadius: 10, padding: "8px 16px", display: "flex", flexDirection: "column", gap: 2, textAlign: "center" },
  tabs:        { display: "flex", gap: 8, marginBottom: 20 },
  tab:         { padding: "8px 18px", border: "2px solid #2d2d44", borderRadius: 8, fontWeight: 600, cursor: "pointer", fontSize: 13 },
  doneCard:    { background: "#1a1a2e", borderRadius: 16, padding: "32px 24px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 10 },
  resultCard:  { background: "#1a1a2e", borderRadius: 16, padding: "24px", display: "flex", flexDirection: "column", alignItems: "center", gap: 8 },
  corrections: { width: "100%", textAlign: "left", marginTop: 16, color: "#fff" },
  ansRow:      { background: "#0f0f1a", borderRadius: 8, padding: "8px 12px", marginBottom: 6 },
  practiceBtn: { padding: "12px 24px", background: "#6c63ff", color: "#fff", border: "none", borderRadius: 10, fontWeight: 800, cursor: "pointer" },
  topBar:      { background: "#1a1a2e", borderRadius: 10, padding: "10px 14px", display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 },
  ...
  qCard:       { background: "#1a1a2e", borderRadius: 14, padding: "20px 16px", marginBottom: 14, border: "1px solid #2d2d44" },
  ...
  navBtn:      { padding: "11px 22px", border: "2px solid #2d2d44", borderRadius: 10, fontWeight: 700, cursor: "pointer", background: "#1a1a2e", color: "#fff", fontSize: 14 },
  historyList: { background: "#1a1a2e", borderRadius: 14, overflow: "hidden", border: "1px solid #2d2d44" },
