      ...
      <div style={s.container}>
        ...
        {tab === "profile" && (
          ...
          <div style={{ marginTop: 16, background: "linear-gradient(135deg, #f0f4ff, #e8f0fe)", borderRadius: 12, padding: 16, border: "1px solid #6C63FF30" }}>
            <div style={{ fontWeight: 700, fontSize: 14, color: "#2d3436", marginBottom: 4 }}>
              Parent Dashboard Code
            </div>
            <div style={{ color: "#636e72", fontSize: 12, marginBottom: 10 }}>
              Share this code with your parent so they can monitor your progress
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ flex: 1, background: "#fff", borderRadius: 8, padding: "10px 14px", fontWeight: 800, fontSize: 18, color: "#6C63FF", letterSpacing: 2, border: "1px solid #6C63FF30", textAlign: "center" }}>
            ...
            <div style={{ color: "#636e72", fontSize: 11, marginTop: 8 }}>
